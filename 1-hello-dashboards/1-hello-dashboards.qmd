...
::: r-box
<https://mine.quarto.pub/weatherdash-r>
:::

::: python-box
<https://mine.quarto.pub/weatherdash-py>
:::

Code: <https://github.com/posit-conf-2024/weatherdash>

## Notebook ➝ Dashboard

::: r-box
``` {.markdown filename="weatherdash-r.qmd" style="overflow-y: hidden" code-line-numbers="|3"}
---
...
::: python-box
``` {.markdown filename="weatherdash-py.qmd" style="overflow-y: hidden" code-line-numbers="|3"}
---
title: "The Weather Dashboard"
format: dashboard
---
